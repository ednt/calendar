...
// OC::$CLASSPATH['OCA\Calendar\Search\Provider'] = 'calendar/lib/search/provider.php';
// OC::$CLASSPATH['OCA\Calendar\Search\Event'] = 'calendar/lib/search/event.php';
...
OCP\App::addNavigationEntry( array(
  ...
  'name' => $l->t('Calendar')));
\OC\Search::registerProvider('OCA\Calendar\Search\Provider');
